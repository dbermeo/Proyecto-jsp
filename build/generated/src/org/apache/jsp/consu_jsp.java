...
public final class consu_jsp extends org.apache.jasper.runtime.HttpJspBase
...
conexion con = new conexion();
    ResultSet rs = con.Consulta("SELECT * FROM \""+request.getParameter("comboc")+"\"");
...
while(rs.next()){ 
      out.write("\n");
      out.write("            <tr>\n");
      out.write("                <td face=\"Tw Cen MT\"><font color=\"white\"> <font size=16>");
